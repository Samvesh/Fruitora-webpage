            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2">
                  ...
                  <div className="rounded-2xl bg-[#FAF9F5] p-3"><Search size={15} /><p className="mt-2 font-bold">{recipe.fruitSlugs?.length || 1}</p><p className="text-xs text-[#656E62]">fruits</p></div>
                </div>
